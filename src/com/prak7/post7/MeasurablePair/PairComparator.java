public final class PairComparator {
    ...
    public static <T extends Comparable<T>, U extends Comparable<U>> boolean isGreater(Pair<T, U> p1, Pair<T, U> p2) {
        // TODO:
        ...
        int compFirst = p1.getFirst().compareTo(p2.getFirst());
        int compSecond = p1.getSecond().compareTo(p2.getSecond());
        return compFirst > 0 && compSecond > 0;
    }
}