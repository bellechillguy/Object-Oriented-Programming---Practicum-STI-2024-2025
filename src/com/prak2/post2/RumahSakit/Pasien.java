//package com.prak2.post2.RumahSakit;
...
public class Pasien {
    ...
    public boolean assignDokter(Dokter dokter) {
        boolean check = false;
        switch (tingkatUrgent) {
            case "Berat":
                check = dokter.getSpesialisasi() == "Jantung" || dokter.getSpesialisasi() == "Anak"; break;
            case "Sedang":
                check = !(dokter.getSpesialisasi() == "Umum"); break;
            case "Ringan":
                check = true; break;
            default: 
                check = false;
        ...
        // else if (tingkatUrgent == "Ringan") {
        //     if (dokter.getSpesialisasi() == "Jantung" || dokter.getSpesialisasi() == "Anak" || dokter.getSpesialisasi() == "Umum") {
        //         return true;
        //     }
        // }
        // else {
        ...
        switch (tingkatUrgent) {
            case "Berat": multiplier = 2.0; break;
